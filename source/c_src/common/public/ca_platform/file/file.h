...
/* -------------------------------------------
   ...
   ------------------------------------------- */
ca_file_handle ca_file_open(const char* path, ca_file_mode mode);
void ca_file_close(ca_file_handle file);
ca_size_t ca_file_read(ca_file_handle file, void* buffer, ca_size_t bytes);
ca_size_t ca_file_write(ca_file_handle file, const void* buffer, ca_size_t bytes);
int ca_file_seek(ca_file_handle file, long offset, ca_file_seek_origin origin);
long ca_file_tell(ca_file_handle file);
int ca_file_flush(ca_file_handle file);
size_t ca_file_get_size(ca_file_handle file);

/* -------------------------------------------
   File status and management
   ------------------------------------------- */
bool ca_file_exists(const char* path);
